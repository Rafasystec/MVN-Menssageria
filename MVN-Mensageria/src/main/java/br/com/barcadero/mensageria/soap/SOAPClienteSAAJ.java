...
public class SOAPClienteSAAJ {
    ...
    public String  sendAndReceive(IServices service,String message) throws Exception{
    	...
    	try{
	        ...
	        //-------------------------------------------------------
	        String url = "http://webservices.sathomologa.sef.sc.gov.br/wsDfeSiv/Recepcao.asmx";
	        SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(message), url);
	        //-------------------------------------------------------
	        //Print SOAP Response
	        //-------------------------------------------------------
